...
class WatchProvidersResponse {
  ...
  factory WatchProvidersResponse.fromJson(Map<String, dynamic> json) => WatchProvidersResponse(
        ...
        rent: (json["rent"] != null && json["rent"] != []) ? List<WatchProviderInfo>.from(json["rent"].map((x) => WatchProviderInfo.fromJson(x))) : [],
        buy: (json["buy"] != null && json["buy"] != []) ? List<WatchProviderInfo>.from(json["buy"].map((x) => WatchProviderInfo.fromJson(x))) : [],
        flatrate: (json["flatrate"] != null && json["flatrate"] != []) ? List<WatchProviderInfo>.from(json["flatrate"].map((x) => WatchProviderInfo.fromJson(x))) : [],
      );
