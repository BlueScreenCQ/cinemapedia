...
Session _sessionDeserialize(
  ...
  final object = Session(
    sessionId: reader.readString(offsets[0]),
  );
  object.isarId = id;
  return object;
}
...
extension SessionQueryFilter
  ...
  QueryBuilder<Session, Session, QAfterFilterCondition> isarIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Session, Session, QAfterFilterCondition> isarIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
